...
'BRICK': {
    ...
    lfoState: [
        { "rate": 0.1166, "depth": 0.1111, "wave": 0, "dest": 300 },
...
'BULLS': { // A driving, percussive patch with a melodic arp over a fast, repeating bass note.
    ...
    arpSettings: {
        ...
        fx: { // Settings for the dedicated ARP knobs
            16: 0.5588,              // Arp 1 RATE (Medium)
            17: 0.9455,              // Arp 2 RATE (Very Fast)
            18: 0,                   // Arp 1 OCTS
            19: 0,                   // Arp 2 OCTS
            22: 0,                   // Arp 1 FEEL
            23: 0,                   // Arp 2 FEEL
...
'XENOM': { // A chaotic, sci-fi preset with a tense, high arp over a massive, repetitive low-end sequence.
    ...
    arpSettings: {
        ...
        fx: { // Settings for the dedicated ARP knobs
            16: 0.5922,              // Arp 1 RATE
            17: 0.5922,              // Arp 2 RATE (Synced)
            ...
            'CELADON': { // A lush, evolving, atmospheric pad sound.
                ...
                arpSettings: {
                    ...
                    fx: {
                        16: 0.1,              // Arp 1 RATE: Extremely slow.
                        17: 0.15,             // Arp 2 RATE: Also extremely slow, but different from Arp 1.
...
'2 NOTES': {
    ...
    fxSettings: [
        ...
        { id: 29, value: 0 },       // OSC 2 RES
        // Dedicated ARP Knobs
        { id: 16, value: 0.4 },     // Rate 1
        { id: 17, value: 0.69 },    // Rate 2
        ...
        fx: { // Settings for the ARP-specific knobs
            ...
            'ZAFFRE': { // A deep, cinematic drone that evolves slowly.
                ...
                arpSettings: {
                    ...
                    fx: {
                        16: 0.05,             // Arp 1 RATE: Extremely slow for a drone effect.
            ...
            'AMARANTH': { // A classic, detuned trance supersaw arpeggio.
                ...
                arpSettings: {
                    ...
                    fx: {
                        16: 0.8,              // Arp 1 RATE: Fast trance speed.
                        17: 0.8,              // Arp 2 RATE: Same speed.
...
'STROLLER': { // A complex, syncopated dual-arp sequence.
                ...
                arpSettings: {
                    ...
                    fx: { // Settings for the dedicated ARP knobs
                        16: 0.8016,          // Arp 1 RATE
                        17: 0.8016,          // Arp 2 RATE
